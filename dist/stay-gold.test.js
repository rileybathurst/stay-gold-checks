    ...
    describe("1. Command runs successfully without errors", () => {
        ...
        it("should execute css-imports checker with src/styles", () => {
            ...
            try {
                ...
                expect(output).toContain("app.css imports every other CSS file in styles/ or src/styles/");
            }
            finally {
...
`);
    ...
    describe("2. Command correctly executes all sub-commands", () => {
        ...
        it("should detect hardcoded CSS values that should use variables", () => {
            writeFileSync(join(stylesDir, "hardcoded-values.css"), "h1 { font-size: 1rem; }\n");
            writeFileSync(join(stylesDir, "variables.css"), ":root {\n  --primary: #000;\n  --secondary: #fff;\n  --vinson: 1rem;\n}\n");
            try {
        ...
        it("should pass CSS variable usage check when var() is used correctly", () => {
            writeFileSync(join(stylesDir, "variables.css"), ":root {\n  --primary: #000;\n  --vinson: 1rem;\n}\n");
            writeFileSync(join(stylesDir, "correct-usage.css"), "h1 { font-size: var(--vinson); }\n");
            try {
        ...
        it("should ignore integer-only variable values and skipped properties", () => {
            ...
            writeFileSync(join(stylesDir, "allowed-hardcoded-values.css"), ".test { width: 0; z-index: 1; order: 2; line-height: 3; grid-row: 1; grid-row: 1 / 2; grid-template-columns: 1fr 1fr; }\n");
            try {
                const output = execSync(`node ${join(process.cwd(), "dist/css-variable-usage.js")}`, {
                    cwd: testDir,
                    stdio: "pipe",
